...
- `ip_ltc2308_adc.vhd` pour la lecture ADC ;
...
```text
0x00000004 = 0x000009C4
0x00000008 = 0x000009C4
...
Après le lancement, `START` retombe automatiquement à 0.  
Le registre revient donc à :
...
```text
0x00000001 : conversion en cours
0x00000002 : conversion terminée
0x00000006 : conversion terminée + SDO à 1
```
...
La prochaine étape est le suivi de ligne automatique.
...
```text
CH3 noir              -> avancer
CH0/CH1/CH2 noir      -> corriger à gauche
CH4/CH5/CH6 noir      -> corriger à droite
aucun capteur noir    -> stop ou recherche
```