...
entity nios_system_cpu_instruction_master_translator_avalon_universal_master_0_agent is
	generic (
		...
		PKT_THREAD_ID_H           : integer := 94;
		PKT_THREAD_ID_L           : integer := 94;
		PKT_CACHE_H               : integer := 101;
		PKT_CACHE_L               : integer := 98;
	...
	port (
		...
		rp_data                 : in  std_logic_vector(103 downto 0) := (others => '0'); --          .data
		rp_channel              : in  std_logic_vector(12 downto 0)  := (others => '0'); --          .channel
