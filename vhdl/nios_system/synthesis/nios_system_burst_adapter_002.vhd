...
entity nios_system_burst_adapter_002 is
	generic (
		...
		PKT_BURST_TYPE_H          : integer := 48;
		PKT_BURST_TYPE_L          : integer := 47;
		...
		OUT_BYTE_CNT_H            : integer := 39;
		OUT_BURSTWRAP_H           : integer := 43;
	...
	port (
		...
		sink0_data            : in  std_logic_vector(66 downto 0) := (others => '0'); --          .data
		sink0_channel         : in  std_logic_vector(2 downto 0)  := (others => '0'); --          .channel
...
begin
	...
	pkt_trans_compressed_read_check : if PKT_TRANS_COMPRESSED_READ /= 32 generate
